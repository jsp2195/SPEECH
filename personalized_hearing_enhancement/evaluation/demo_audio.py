...
def run_demo_audio(
    ...
    listener_space = {
        "impaired_input": listener_space_metrics(clean, degraded, ag, sr=sr),
        "baseline": listener_space_metrics(clean, baseline_enh, ag, sr=sr),
        "calibration": listener_space_metrics(clean, calibration, ag, sr=sr),
        "conditioned": listener_space_metrics(clean, conditioned_enh, ag, sr=sr),
    }
