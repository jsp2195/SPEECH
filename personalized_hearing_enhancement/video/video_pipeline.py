...
def process_audio(
    ...
    b = safe_post_amplification(b, reference=degraded)
    c = safe_post_amplification(c, reference=degraded)
    calibration = safe_post_amplification(calibration, reference=degraded)
...
def create_comparison_video(
    ...
    labels = {
        ...
        "baseline": "3) baseline enhancement",
        "calibration": "4) calibration-filter output",
        "conditioned": "5) ML model output",
    }
